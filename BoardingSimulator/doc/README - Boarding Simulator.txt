...
The nature of the game is very time sensitive, so some precise measurement of the time and a way to save the time to make the game more competitive and allow for something like a “speedrun”[b]
...
Aryan Keskar: Drawing surface, GUI Interactive ,Main, html documentation, UML
