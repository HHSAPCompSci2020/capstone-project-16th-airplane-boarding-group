...
There are no keyboard inputs, where the user must assign the passengers through the use of typing in the correlating code on the seat to move the next passenger in line. For example, typing “A1 or C5” would move a passenger to seat “A1 or C5” and vice versa for the rest of the passengers and seats.


Where will you need to click? 
* Mainscreen
        - Click the change color to change colors
        - click or drag each seats to assign seats to colors
        - 
*Queue Screen
	- Moving around the color coded squares, the one with the highest value is the one that goes first and so on and so forth.
...
Vamsee Krishna Vusuwandla: README,Drawing surface , UML, 
...
[a]This is a very interesting reason to use the program, you seem to be very passionate about how airlines are being inefficient for the sake of money.
[b]It's very interesting to also account for people who want to try and make things as fast and efficient as possible.